...
//customize settings\\
global.owner = ['01020260148']
global.premium = ['01020260148']
global.ownernomer = '01020260148'
...
global.mess = {
    success: '✓',
    admin: '*「 يورع هذا للأدمن فقط 」◣*',
    botAdmin: '*「 اديني ادمن الاول كده 」◣*',
    owner: '*「 سوره هذا للمالك فقط 」◣*',
    group: '*「 جربه في المجموعه 」◣*',
    private: '*「 جربه في الخاص 」◣*',
    bot: '*「 يورع هذا للمالك فقط 」◣*',
    wait: '*「 ثانيا كداا 」◣*',
